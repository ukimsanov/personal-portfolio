...
export function ThemeToggler() {
  return (
    <AnimatedThemeToggler
      className="p-3 rounded-full border border-border/70 hover:border-border active:scale-95 transition-all duration-200 ease-out hover:shadow-md min-h-[44px] min-w-[44px] flex items-center justify-center"
      duration={400}
    >
